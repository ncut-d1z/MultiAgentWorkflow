...
class CodexCliBackend:
    ...
    def login(self) -> int:
        return subprocess.run([self.codex_binary, "login"], env=self._env(), check=False).returncode
            ...
            if completed.returncode != 0:
                ...
                if "model" in lowered and (
                    ...
                    hint = (
                        ...
                        "account route. MultiAgentWorkflow never silently substitutes another model."
                    )
